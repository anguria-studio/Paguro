...
public struct ConfigurationArchive: Codable, Equatable, Sendable {
    public var format = "paguro-configuration"
...
public enum ConfigurationArchiveCodec {
    ...
    public static func decode(_ data: Data) throws -> ConfigurationArchive {
        ...
        catch { throw invalid("This is not a complete Paguro configuration file.") }
    ...
    public static func validate(_ archive: ConfigurationArchive) throws {
        guard archive.format == "paguro-configuration", archive.version == 1 else {
            throw invalid("This configuration format is not supported. Update Paguro and try again.")
        }
