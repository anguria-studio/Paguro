...
/// One live store or backup that Blatta can show in the recovery picker.
...
/// Why Blatta offers to restore a backup.
...
public enum StoreRecoveryPolicy {
    ...
    /// Returns whether Blatta should offer a restore, and why.
