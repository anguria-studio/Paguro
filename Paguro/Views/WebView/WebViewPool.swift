...
final class WebViewPool {
    ...
    /// The effective Paguro window appearance. Automatic services follow it.
    ...
    /// service's "open links in Paguro" choice.
    ...
    /// Applies a Paguro appearance change to every live service. Automatic
