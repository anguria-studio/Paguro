...
final class WebViewCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    ...
    /// match the URL against an existing Paguro service before falling back
    ...
    /// Paguro" choice. When nil the coordinator falls back to `NSWorkspace.open`
    /// directly.
    ...
    /// Set just before Paguro loads one of its own error pages into the web
    ...
    /// Whether a link that leaves a service (and that no other Paguro service
    /// owns) should open in an in-app Paguro window rather than the system
    ...
    func webViewWebContentProcessDidTerminate(_ webView: WKWebView) {
        ...
        guard Self.shouldAutoReload(
            ...
            let html = ErrorPage.html(
                ...
                message: "Paguro stopped reloading it automatically to avoid a loop. You can try again, or switch to another service.",
