...
struct WindowChromeConfigurator: NSViewRepresentable {
    ...
    final class Coordinator {
        ...
        func configure(
            ...
            window.contentMinSize = NSSize(
                width: PaguroMetric.Window.minimumContentWidth,
    ...
    /// `(26, 26)` and uses a 23 point gap between button centers. Paguro keeps its
    ...
    private static func applyReferenceTrafficLightGeometry(to window: NSWindow) {
        ...
        let centerY: CGFloat = PaguroMetric.Toolbar.height / 2
