...
struct ServiceRowView: View {
    ...
    var dockRowHeight = PaguroMetric.Sidebar.dockRowHeight
    ...
    static let rowWidth = PaguroMetric.Sidebar.rowWidth
    /// Compact source-list row height.
    static let rowHeight = PaguroMetric.Sidebar.rowHeight
    ...
    private static let iconCornerRadius = PaguroRadius.icon
    ...
    private var iconOnlyContent: some View {
        serviceIcon(size: PaguroMetric.Sidebar.barIconOnlySize)
...
struct RailTooltipView: View {
    ...
    var body: some View {
        Text(text)
            ...
            .overlay {
                RoundedRectangle(
                    cornerRadius: PaguroRadius.surface,
                    style: .continuous
                )
