...
struct RailReorderModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            ...
            .shadow(
                color: PaguroColor.railLiftShadow.opacity(isLifted ? 1 : 0),
    ...
    private var liftAnimation: Animation? {
        reduceMotion ? nil : .smooth(duration: PaguroMotion.railLiftSeconds)
    }
    ...
    private var reorderAnimation: Animation? {
        ...
        return .spring(
            response: PaguroMotion.railReorderResponse,
            dampingFraction: PaguroMotion.railReorderDamping
        )
    }
