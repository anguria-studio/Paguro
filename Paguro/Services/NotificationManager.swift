...
final class NotificationManager {
    ...
    /// Paguro asks macOS for the permission once for each launch.
    ///
    ...
    /// reported `denied` that hides a failed registration, so Paguro asks
    ...
    ///
    /// The user can change the permission in System Settings while Paguro runs,
    ...
    /// `UserNotifications` type reaches `PaguroCore`.
    static func state(
