...
final class AppPreferences {
    ...
    /// Retired compatibility field. Paguro's current commands are always active;
    ...
    /// Paguro-wide default page zoom applied to services that have no explicit
    ...
    /// keeps a limited number of services loaded at the same time, and can
