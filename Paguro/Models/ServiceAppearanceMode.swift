...
/// The color-scheme signal that Paguro gives to one web service.
///
/// Automatic follows the Paguro window. Light and dark are explicit overrides.
...
enum ServiceAppearanceMode: String, CaseIterable {
    ...
    var displayName: String {
        switch self {
        case .automatic: return "Follow Paguro"
    ...
    /// appearance. An old Off or Auto value now follows Paguro. An old On value
