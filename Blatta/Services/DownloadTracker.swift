...
final class DownloadTracker {
    ...
    /// One download that Blatta started for a service.
    struct Item: Identifiable, Equatable {
        ...
        let id: UUID
        /// The service that started the download. It is nil when Blatta cannot
    ...
    /// Blatta cannot attribute stays visible instead of disappearing.
