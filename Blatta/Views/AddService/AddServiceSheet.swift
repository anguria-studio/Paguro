...
struct AddServiceSheet: View {
    ...
    private var passkeyNotice: some View {
        ...
        .background(Color(nsColor: .controlBackgroundColor), in: RoundedRectangle(cornerRadius: BlattaRadius.control))
        .padding(.horizontal, 20)
        .padding(.bottom, 4)
    ...
    private var catalogContent: some View {
        VStack(spacing: 0) {
            ...
            .padding(.horizontal, 10)
            .padding(.vertical, 7)
            .background(Color(nsColor: .textBackgroundColor), in: RoundedRectangle(cornerRadius: BlattaRadius.control))
            .overlay(
    ...
    private func addCustomService(label: String, url: String) {
        guard appState.addService(
            ...
            urlError = "Blatta could not save this service. Try again."
            return
        }
