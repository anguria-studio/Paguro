...
/// a bundled catalog mark. The source URL is only used for the fetch; Blatta
...
struct ServiceIconEditor: View {
    ...
    private var preview: some View {
        ...
        .clipShape(RoundedRectangle(cornerRadius: BlattaRadius.icon))
        .overlay {
            RoundedRectangle(cornerRadius: BlattaRadius.icon)
