...
/// The compact Blatta control surface that macOS presents from the status item.
/// It keeps service navigation available when Blatta runs without a Dock icon.
struct MenuBarView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("Blatta menu bar window")
    }
    ...
    private var serviceList: some View {
        if hasServices {
            ...
            ContentUnavailableView(
                ...
                description: Text("Open Blatta to add your first service.")
            )
            .frame(height: 180)
        }
    }
    ...
    private var footer: some View {
        HStack(spacing: 8) {
            Button {
                ...
                Label("Open Blatta", systemImage: "macwindow")
            ...
            .help("Settings")
            .accessibilityLabel("Open Blatta Settings")
        }
        .padding(12)
    }
...
private struct MenuBarWindowSurface: View {
    ...
    var body: some View {
        ZStack {
            ...
            Rectangle()
                .fill(BlattaColor.shellTint(intensity: transparency))
        }
    }
