...
enum BlattaMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [BlattaSchemaV1_5_11.self, BlattaSchemaV1_5_12.self, BlattaSchemaVCurrent.self]
    }
    ...
    static var stages: [MigrationStage] {
        [
            ...
            .lightweight(fromVersion: BlattaSchemaV1_5_12.self, toVersion: BlattaSchemaVCurrent.self),
        ]
    }
}
