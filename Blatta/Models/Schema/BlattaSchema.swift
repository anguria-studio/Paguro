...
//
// Why this exists: Blatta used to open its store with a plain `Schema` and let
...
// Freeze the prior shape as a new `BlattaSchemaV…`, bump `BlattaSchemaVCurrent`'s
...
enum BlattaSchemaV1_5_11: VersionedSchema {
...
enum BlattaSchemaV1_5_12: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [ServiceInstance.self, Space.self, SpaceServiceLink.self, BlattaSchemaV1_5_11.AppPreferences.self]
    }
...
//
// Frozen on 2026-08-30. This is the shape Blatta inherited from Chorus, and it
...
enum BlattaSchemaV1_5_13: VersionedSchema {
...
// THIS shape into a new `BlattaSchemaV…` before editing the live models, then
// bump the identifier here.

enum BlattaSchemaVCurrent: VersionedSchema {
    // NOTE: `versionIdentifier` is a schema-SHAPE label, not the app's marketing
    // version, and these numbers are Chorus's shape history rather than Blatta's
    ...
    // (1,5,13) now belongs to the frozen `BlattaSchemaV1_5_13`, which is the
    // shape Blatta inherited; this one is (1,5,19) because making
...
enum BlattaMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [BlattaSchemaV1_5_11.self, BlattaSchemaV1_5_12.self, BlattaSchemaV1_5_13.self, BlattaSchemaVCurrent.self]
    }

    static var stages: [MigrationStage] {
        [
            // 1.5.11 → 1.5.12: adds ServiceInstance.stayActiveInBackground (optional).
            .lightweight(fromVersion: BlattaSchemaV1_5_11.self, toVersion: BlattaSchemaV1_5_12.self),
            // 1.5.12 → 1.5.13: adds ServiceInstance.hibernationPolicyRaw + hibernateAfterMinutes (optional).
            .lightweight(fromVersion: BlattaSchemaV1_5_12.self, toVersion: BlattaSchemaV1_5_13.self),
            ...
            .lightweight(fromVersion: BlattaSchemaV1_5_13.self, toVersion: BlattaSchemaVCurrent.self),
        ]
    }
}
