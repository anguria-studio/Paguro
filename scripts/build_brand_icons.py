...
as asset-catalog imagesets under Paguro/Resources/Assets.xcassets.
...
ASSETS = os.path.normpath(
    os.path.join(os.path.dirname(__file__), "..", "Paguro", "Resources", "Assets.xcassets")
)
...
SLUGS = {
    ...
    "google-chat":"google-chat","linkedin":"linkedin","x":"x",
    "instagram":"instagram","facebook":"facebook","reddit":"reddit",
    "notion":"notion","trello":"trello","asana":"asana","linear":"linear",
    "google-calendar":"google-calendar","google-drive":"google-drive","figma":"figma",
