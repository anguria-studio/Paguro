        ...
        VStack(spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    .help("Atoll frees a service's memory and CPU while it runs in the background. The one you're viewing always stays loaded. \"Never\" also keeps calls and notifications working in the background, at the cost of more memory.")
                ...
                Toggle("Open outside links in Atoll", isOn: $openLinksInApp)
                    .help("When a link in this service points somewhere no Atoll service covers, open it in a Atoll window instead of your browser. Links that another service does cover still switch to that service.")
