...
//
// Why this exists: Atoll used to open its store with a plain `Schema` and let
...
// Freeze the prior shape as a new `AtollSchemaV…`, bump `AtollSchemaVCurrent`'s
...
enum AtollSchemaV1_5_11: VersionedSchema {
...
enum AtollSchemaV1_5_12: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [ServiceInstance.self, Space.self, SpaceServiceLink.self, AtollSchemaV1_5_11.AppPreferences.self]
    }
...
// THIS shape into a new `AtollSchemaV…` before editing the live models, then
// bump the identifier here.

enum AtollSchemaVCurrent: VersionedSchema {
...
enum AtollMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [AtollSchemaV1_5_11.self, AtollSchemaV1_5_12.self, AtollSchemaVCurrent.self]
    }

    static var stages: [MigrationStage] {
        [
            // 1.5.11 → 1.5.12: adds ServiceInstance.stayActiveInBackground (optional).
            .lightweight(fromVersion: AtollSchemaV1_5_11.self, toVersion: AtollSchemaV1_5_12.self),
            // 1.5.12 → current: adds ServiceInstance.hibernationPolicyRaw + hibernateAfterMinutes (optional).
            .lightweight(fromVersion: AtollSchemaV1_5_12.self, toVersion: AtollSchemaVCurrent.self),
        ]
    }
}
