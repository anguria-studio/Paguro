...
final class NativeShellTests: XCTestCase {
    ...
    func testSidebarPresentationMapsToSharedGeometry() {
        XCTAssertEqual(SidebarPresentation.expanded.width, BlattaMetric.Sidebar.expandedWidth)
        XCTAssertEqual(SidebarPresentation.expanded.serviceRowHeight, BlattaMetric.Sidebar.rowHeight)
        XCTAssertEqual(SidebarPresentation.expanded.surfaceTopInset, BlattaMetric.Sidebar.surfaceInset)
        XCTAssertEqual(SidebarPresentation.expanded.surfaceBottomInset, BlattaMetric.Sidebar.surfaceInset)
        XCTAssertEqual(SidebarPresentation.expanded.contentTopInset, BlattaMetric.Sidebar.topBarHeight)
        XCTAssertEqual(
        ...
        XCTAssertEqual(SidebarPresentation.collapsed.width, BlattaMetric.Sidebar.collapsedWidth)
        XCTAssertEqual(SidebarPresentation.collapsed.serviceRowHeight, BlattaMetric.Sidebar.dockRowHeight)
        XCTAssertEqual(
            SidebarPresentation.collapsed.surfaceTopInset,
            BlattaMetric.Sidebar.collapsedSurfaceTopInset
        )
        XCTAssertEqual(SidebarPresentation.collapsed.surfaceBottomInset, BlattaMetric.Sidebar.surfaceInset)
        XCTAssertEqual(
            SidebarPresentation.collapsed.contentTopInset,
            BlattaMetric.Sidebar.collapsedContentTopInset
        )
        XCTAssertEqual(
