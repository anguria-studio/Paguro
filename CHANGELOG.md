...
- The expanded island keeps its count badge and its Clear All button below the
  top screen edge. Both controls follow the camera-housing height and stay easy
  to read and to hit, also at a larger system text size.
