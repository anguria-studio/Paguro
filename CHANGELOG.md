...
- Music and voice messages keep playing when you switch to another service. A
  WhatsApp Web voice message runs to its end while you read Telegram. The
  ...
  silences it. A page that starts to play after you leave it stays quiet, and a
  service that only shows a silent animation earns no mark.
